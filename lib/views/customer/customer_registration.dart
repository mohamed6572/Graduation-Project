...
SizedBox(height: 4.h,),
                Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('Your City',style: TextStyle(fontWeight: FontWeight.bold,color: AppColors().primaryColor2,fontSize: 19.5.sp),)
                  ,SizedBox(width: 4.w,),
                    CityDropDown(
                ...
                , RegTextField(labelText: "Address", notMobileNumber: true, numberInput: false, isPassword: false, validator: (text) {
                  if (text == null || text.isEmpty) {
                    return 'Please enter some text';
                  }
                  return null;
